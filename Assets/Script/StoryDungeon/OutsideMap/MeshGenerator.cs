...
public class MeshGenerator : MonoBehaviour
{
    ...
    {
        // 전체 점 위치 담아놓을 list
        pointList = new List<Vector3>(heightArr.GetLength(0) * heightArr.GetLength(1));  // 배열 가로x세로 만큼 생성
    ...
    private void F_CreateMesh(int v_y, int v_x, float v_height) // 시작 인덱스 , 높이
    {
